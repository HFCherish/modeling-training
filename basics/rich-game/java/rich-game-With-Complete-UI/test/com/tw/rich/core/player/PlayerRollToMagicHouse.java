...
import com.tw.rich.core.places.MagicHouse;
 ...
 */
public class PlayerRollToMagicHouse {
    ...
    public void setUp() {
        ...
        when(map.move(any(), anyInt())).thenReturn(magicHouse);
    ...
    public void should_end_turn_and_go_to_prison() {
        ...
        assertThat(player.currentPlace(), is(magicHouse));
    }
