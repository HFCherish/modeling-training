...
import com.thoughtworks.shopping.infrastructure.records.Models;
import com.thoughtworks.shopping.infrastructure.util.DefaultEncryptionService;
...
public abstract class InjectBasedRunner extends BlockJUnit4ClassRunner {
    ...
    private List<AbstractModule> getAbstractModules() {
        ...
        String connectURL = String.format(
                "jdbc:mysql://%s:%s/%s?users=%s&password=%s&allowMultiQueries=true&zeroDateTimeBehavior=convertToNull",
                host,
                port,
                dbname,
                username,
